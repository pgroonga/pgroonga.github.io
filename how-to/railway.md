...
Please take the following precautions before using this template for production workloads:

* When connecting from another service in the same Railway project, use Railway's [private networking](https://docs.railway.com/guides/private-networking) instead of the public TCP proxy.
