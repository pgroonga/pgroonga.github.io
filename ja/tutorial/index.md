...
全文検索をする場合は次の演算子を使います。
  ...
  * [`&@`演算子](../reference/operators/match-v2.html)
  * [`&?`演算子](../reference/operators/query-v2.html)
  * [`LIKE`演算子](../reference/operators/like.html)
  * `ILIKE`演算子
...
PGroonga は JSON 内のすべてのテキスト値に対する全言語対応全文検索もサポートしています。
...
PGroongaは`jsonb`に対して検索するために次の2つの演算子を提供しています。
  ...
  * [`@>`演算子](../reference/operators/jsonb-contain.html)
  * [`` &` ``演算子](../reference/operators/script-jsonb-v2.html)
...
詳細は[`` &` ``演算子](../reference/operators/script-jsonb-v2.html)を参照してください。
